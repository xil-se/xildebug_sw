...
{
	LL_GPIO_SetOutputPin(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin);
	LL_GPIO_SetOutputPin(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin);

	LL_GPIO_SetPinMode(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinOutputType(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin, LL_GPIO_OUTPUT_PUSHPULL);
	LL_GPIO_SetPinPull(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin, LL_GPIO_PULL_UP);

	LL_GPIO_SetPinMode(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin, LL_GPIO_MODE_OUTPUT);
	LL_GPIO_SetPinOutputType(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin, LL_GPIO_OUTPUT_PUSHPULL);
	LL_GPIO_SetPinPull(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin, LL_GPIO_PULL_UP);
...
{
	LL_GPIO_SetPinMode(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinPull(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin, LL_GPIO_PULL_NO);

	LL_GPIO_SetPinMode(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin, LL_GPIO_MODE_INPUT);
	LL_GPIO_SetPinPull(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin, LL_GPIO_PULL_NO);
...
{
	return LL_GPIO_IsOutputPinSet(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin);
}
...
{
	LL_GPIO_ResetOutputPin(DUT_SWCLK_GPIO_Port, DUT_SWCLK_Pin);
}

static inline uint8_t PIN_SWDIO_TMS_IN(void)
{
	return LL_GPIO_IsInputPinSet(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin);
}
...
{
	LL_GPIO_ResetOutputPin(DUT_SWDIO_GPIO_Port, DUT_SWDIO_Pin);
}
